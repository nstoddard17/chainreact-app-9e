...
async function runWebhookMigration() {
  ...
  console.log('\n📋 WEBHOOK MIGRATION')
  console.log('=' * 50)
  console.log(webhookMigrationSQL)
  
  console.log('\n🎯 Instructions:')
  console.log('1. Go to your Supabase Dashboard')
  console.log('2. Navigate to SQL Editor')
  console.log('3. Copy and paste the webhook migration SQL')
  ...
  console.log('✅ Helper functions for logging')
}

runWebhookMigration().catch(console.error) 