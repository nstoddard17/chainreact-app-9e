...
async function runWebhookMigrationFixed() {
  console.log('🚀 Starting fixed webhook migration...')
  console.log('📋 This migration fixes the column reference error:')
  
  const webhookMigrationFixedSQL = `
    -- Create webhook management tables (FIXED VERSION)
    ...
    -- Function to log webhook execution (FIXED - removed webhook_id reference)
  ...
  console.log('\n📋 FIXED WEBHOOK MIGRATION')
  console.log('=' * 50)
  console.log(webhookMigrationFixedSQL)
  
  console.log('\n🎯 Instructions:')
  console.log('1. Go to your Supabase Dashboard')
  console.log('2. Navigate to SQL Editor')
  console.log('3. Copy and paste the fixed webhook migration SQL')
  console.log('4. Click "Run"')
  console.log('5. Verify the tables were created successfully')
  
  console.log('\n🔧 What was fixed:')
  console.log('✅ Removed the problematic column reference in the function')
  console.log('✅ Ensured all tables are created before functions')
  console.log('✅ Fixed the webhook_id column reference error')
  
  console.log('\n📊 What will be added:')
  console.log('✅ webhook_configs table for webhook configurations')
  console.log('✅ webhook_executions table for execution logs')
  console.log('✅ webhook_subscriptions table for external service registrations')
  console.log('✅ RLS policies for security')
  console.log('✅ Automatic triggers for timestamps')
  console.log('✅ Performance indexes')
  console.log('✅ Fixed helper functions for logging')
}

runWebhookMigrationFixed().catch(console.error) 