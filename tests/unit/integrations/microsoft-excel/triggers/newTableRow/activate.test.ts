...
import { activate } from "@/integrations/microsoft-excel/triggers/newTableRow/activate";
...
function ctx(overrides?: Partial<{ tableName: string }>): {
  ...
  const node: WorkflowNode = {
    id: "n-1",
    type: "microsoft-excel:new_table_row",
    provider: "microsoft-excel",
    kind: "trigger",
    config: {
      workbookId: "wb-1",
...
describe("new_table_row activation hook", () => {
