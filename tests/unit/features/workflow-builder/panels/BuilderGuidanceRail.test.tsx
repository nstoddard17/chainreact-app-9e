...
describe("BuilderGuidanceRail — 'Check workflow' pill (BUILDER-AGENT-RAIL-CHECK-WORKFLOW)", () => {
  ...
  it("clicking it runs an INSTANT deterministic review — no prefill, no requestWorkflowGuidance/LLM/credits", async () => {
    const user = userEvent.setup();
    ...
    // Review rendered locally, honoring the deterministic verdict — no governed request fired.
