  ...
  try {
    ...
    if (error) {
      return new Response(
        ...
        <html>
          <head>
            <title>Google Drive OAuth Error</title>
            <style>
              body {
    ...
    const result = await GoogleDriveOAuthService.handleCallback(code, state, supabase, userId, origin)
        ...
        <html>
          ...
          <body>
            <div class="container">
              ...
              <p>${result.error || "Failed to connect Google Drive"}</p>
            </div>
          </body>
        </html>
        `,
