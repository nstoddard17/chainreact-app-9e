...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    try {
      ...
      console.error("Invalid state parameter in Google Drive callback:", e)
      return createPopupResponse(
        "error",
        "google-drive",
    ...
    if (upsertError) {
      console.error("Error saving Google Drive integration to DB:", upsertError)
      return createPopupResponse(
        "error",
        "google-drive",
    ...
    return createPopupResponse("error", "google-drive", errorMessage, baseUrl)
  }
}
