/**
 * dropbox Integration Data Route
 *
 * Thin adapter — delegates to shared handler with provider hardcoded to 'dropbox'.
...
export async function POST(req: NextRequest) {
  return handleIntegrationDataRequest('dropbox', req)
}
