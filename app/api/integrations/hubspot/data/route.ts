/**
 * hubspot Integration Data Route
 *
 * Thin adapter — delegates to shared handler with provider hardcoded to 'hubspot'.
...
export async function POST(req: NextRequest) {
  return handleIntegrationDataRequest('hubspot', req)
}
