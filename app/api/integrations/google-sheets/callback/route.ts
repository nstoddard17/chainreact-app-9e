  ...
  try {
    ...
    if (error) {
      return new Response(
        ...
        <html>
          <head>
            <title>Google Sheets OAuth Error</title>
            <style>
              body {
    ...
    const result = await GoogleSheetsOAuthService.handleCallback(code, state, supabase, userId, origin)
        ...
        <html>
          ...
          <body>
            <div class="container">
              ...
              <p>${result.error || "Failed to connect Google Sheets"}</p>
            </div>
          </body>
        </html>
        `,
