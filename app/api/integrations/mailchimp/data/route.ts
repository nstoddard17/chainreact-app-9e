/**
 * mailchimp Integration Data Route
 *
 * Thin adapter — delegates to shared handler with provider hardcoded to 'mailchimp'.
...
export async function POST(req: NextRequest) {
  return handleIntegrationDataRequest('mailchimp', req)
}
