/**
 * blackbaud Integration Data Route
 *
 * Thin adapter — delegates to shared handler with provider hardcoded to 'blackbaud'.
...
export async function POST(req: NextRequest) {
  return handleIntegrationDataRequest('blackbaud', req)
}
