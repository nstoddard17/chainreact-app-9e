/**
 * google-analytics Integration Data Route
 *
 * Thin adapter — delegates to shared handler with provider hardcoded to 'google-analytics'.
...
export async function POST(req: NextRequest) {
  return handleIntegrationDataRequest('google-analytics', req)
}
