/**
 * Notion Page Blocks Selectable Handler
 * Fetches blocks from a page formatted for simple dropdown selection
 * Returns {value, label} format suitable for select/combobox fields
 */
...
/**
 * Fetch all blocks from a Notion page formatted for dropdown selection
 */
export const getNotionPageBlocksSelectable: NotionDataHandler<SelectableBlock> = async (
  ...
  try {
    ...
    logger.error("❌ [Notion Selectable Blocks] Error:", error.message)
    throw error
  }
}
