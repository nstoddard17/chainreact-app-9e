...
// Run-record DTO serialization (+ output redaction / error sanitization) lives in
// the sibling _runDtos.ts to keep this file under the size cap. Re-exported so
// route files importing these from `_shared` are unchanged.
export { toWorkflowRunSummary, toWorkflowRunDetail } from "./_runDtos";
