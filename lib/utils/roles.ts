...
export const ROLES: Record<UserRole, RoleInfo> = {
  ...
  'beta-pro': {
    ...
    badgeColor: '!bg-purple-100 !text-purple-800 border border-purple-300 dark:!bg-purple-900 dark:!text-white dark:!border-transparent dark:ring-1 dark:ring-inset dark:ring-purple-500',
