...
export async function executeAction({ node, input, userId, workflowId }: ExecuteActionParams): Promise<ActionResult> {
  ...
  const handlerMap: Record<string, Function> = {
    ...
    "discord_action_fetch_reactions": fetchDiscordReactions,
    ...
    "discord_action_fetch_roles": listDiscordRoles,
    "discord_action_create_role": createDiscordRole,
    "discord_action_update_role": updateDiscordRole,
    "discord_action_delete_role": deleteDiscordRole,
