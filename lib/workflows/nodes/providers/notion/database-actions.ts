import { Database, Search, Plus, Trash2, RotateCcw, FilePlus } from "lucide-react"
...
export const notionDatabaseActions: NodeComponent[] = [
  ...
  // ============= QUERY DATABASE =============
  {
    ...
    description: "Query database entries with filters and sorting",
    icon: Search,
    providerId: "notion",
    ...
    configSchema: [
      ...
      },
      {
        ...
        visibilityCondition: { field: "filterType", operator: "equals", value: "json" }
      },
      {
        name: "sorts",
