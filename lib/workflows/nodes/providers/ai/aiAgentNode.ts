...
The AI will structure its output accordingly.`,
  ...
  outputSchema: [
    ...
    // ========================================
    {
      ...
      label: "AI Response",
      type: "string",
      description: "Main text generated by the AI (response, summary, translation, etc.)"
    },
    {
      name: "data",
      label: "Structured Data",
      type: "object",
      description: "Any extracted or structured data as key-value pairs"
    },
    ...
    // ========================================
    {
      ...
      label: "Email Subject",
      type: "string",
      description: "Generated email subject line (for Respond action)"
    },
