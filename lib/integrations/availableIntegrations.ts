...
export const INTEGRATION_CONFIGS: Record<string, IntegrationConfig> = {
  ...
  box: {
    ...
    capabilities: ["File Storage", "File Sharing", "Collaboration", "Version Control", "User Management", "Group Management", "Webhook Management"],
    scopes: ["root_readwrite", "manage_users", "manage_groups", "manage_webhooks", "enable_integrations"],
    isAvailable: true,
