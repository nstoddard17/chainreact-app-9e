...
export const INTEGRATION_CONFIGS: Record<string, IntegrationConfig> = {
  ...
  teams: {
    ...
    scopes: ["User.Read", "Team.ReadBasic.All", "Channel.ReadBasic.All", "Chat.Read", "ChatMessage.Send", "OnlineMeetings.ReadWrite"],
    isAvailable: false,
  ...
  "microsoft-outlook": {
    ...
    isAvailable: false,
    requiresClientId: "NEXT_PUBLIC_OUTLOOK_CLIENT_ID",
  ...
  "microsoft-onenote": {
    ...
    isAvailable: true,
    requiresClientId: "NEXT_PUBLIC_ONENOTE_CLIENT_ID",
