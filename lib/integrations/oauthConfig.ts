...
export const OAUTH_PROVIDERS: Record<string, OAuthProviderConfig> = {
  ...
  "google-analytics": {
    ...
    accessTokenExpiryBuffer: 30,
    sendRedirectUriWithRefresh: true,
    redirectUriPath: "/api/integrations/google-analytics/callback",
  },
  github: {
    id: "github",
    name: "GitHub",
  ...
  "microsoft-excel": {
    ...
    clientIdEnv: "EXCEL_CLIENT_ID",
    clientSecretEnv: "EXCEL_CLIENT_SECRET",
    authEndpoint: "https://login.microsoftonline.com/common/oauth2/v2.0/authorize",
    tokenEndpoint: "https://login.microsoftonline.com/common/oauth2/v2.0/token",
    refreshRequiresClientAuth: true,
    authMethod: "body",
    ...
    sendScopeWithRefresh: true,
    sendRedirectUriWithRefresh: true,
    redirectUriPath: "/api/integrations/excel/callback",
    scope: "offline_access https://graph.microsoft.com/User.Read https://graph.microsoft.com/Files.ReadWrite.All",
  },
  "microsoft-outlook": {
  ...
  teams: {
    ...
    scope: "offline_access https://graph.microsoft.com/User.Read https://graph.microsoft.com/User.ReadBasic.All https://graph.microsoft.com/User.Invite.All https://graph.microsoft.com/Team.ReadBasic.All https://graph.microsoft.com/Team.Create https://graph.microsoft.com/TeamMember.Read.All https://graph.microsoft.com/TeamMember.ReadWrite.All https://graph.microsoft.com/Channel.ReadBasic.All https://graph.microsoft.com/Channel.Create https://graph.microsoft.com/Channel.Delete.All https://graph.microsoft.com/ChannelMessage.Read.All https://graph.microsoft.com/ChannelMessage.Send https://graph.microsoft.com/ChannelMessage.Edit https://graph.microsoft.com/Chat.Read https://graph.microsoft.com/Chat.ReadWrite https://graph.microsoft.com/Chat.Create https://graph.microsoft.com/ChatMessage.Read https://graph.microsoft.com/ChatMessage.Send https://graph.microsoft.com/OnlineMeetings.ReadWrite https://graph.microsoft.com/Calendars.ReadWrite",
  },
  hubspot: {
    id: "hubspot",
    name: "HubSpot",
