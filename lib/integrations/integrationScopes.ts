...
export const INTEGRATION_SCOPES: Record<string, IntegrationScopeConfig> = {
  ...
  teams: {
    ...
    components: {
      ...
      "teams-read-calendar": ["https://graph.microsoft.com/Calendars.ReadWrite"],
      "teams-write-calendar": ["https://graph.microsoft.com/Calendars.ReadWrite"],
      "teams-read-files": ["https://graph.microsoft.com/Files.ReadWrite"],
      "teams-write-files": ["https://graph.microsoft.com/Files.ReadWrite"],
      "teams-read-mail": ["https://graph.microsoft.com/Mail.ReadWrite"],
      "teams-send-mail": ["https://graph.microsoft.com/Mail.ReadWrite"],
    },
  },
  trello: {
    provider: "trello",
