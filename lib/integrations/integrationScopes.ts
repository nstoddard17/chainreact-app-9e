...
export const INTEGRATION_SCOPES = {
  slack: {
    required: ["chat:write", "chat:write.customize", "channels:read", "groups:write", "users:read", "team:read", "files:read", "files:write"],
    optional: ["groups:read", "im:read", "mpim:read", "reminders:write", "reminders:read", "reactions:write", "reactions:read"],
  },
  discord: {
