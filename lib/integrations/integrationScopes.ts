...
export const INTEGRATION_SCOPES: Record<string, IntegrationScopeConfig> = {
  slack: {
    ...
    scopes: [
      ...
      { scope: "channels:write", description: "Create and manage channels", required: false },
      ...
      { scope: "users:read.email", description: "View user email addresses", required: false },
      ...
      { scope: "team:read", description: "View workspace info", required: false },
    ],
    components: {
      ...
      "slack-create-channel": ["channels:write"],
