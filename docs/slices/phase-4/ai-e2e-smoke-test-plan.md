...
7d. Click **Clear** at any point during a follow-up chain. **Expected:** the callout disappears, the composer reverts to "Plan with AI", and the next submit is treated as a brand-new prompt (not a follow-up).
