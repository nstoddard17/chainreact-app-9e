...
| **COST-15G** | shipped | Internal rollout readiness plan ([reserve-reconcile-internal-rollout-readiness.md](./reserve-reconcile-internal-rollout-readiness.md)). Doc only. **Allowlist section since rejected** (pre-launch); the rest (shadow thresholds, ops/sweep, rollback, risks) stands. |
