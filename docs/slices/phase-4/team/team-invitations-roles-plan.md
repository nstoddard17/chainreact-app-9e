...
[ownership](../account-model/account-model-closeout.md) / [deletion](../account-model/account-deletion-flow-closeout.md)
/ [switcher](../account-model/account-switcher-closeout.md) closeouts, and the D1 team-creation
