...
export const shopifyCreateProductVariantMeta: ActionMeta = {
  ...
  fields: [
    ...
    },
    {
      name: "option1",
      label: "Option 1",
      description: "Optional value for the product's first option position.",
      type: "text",
      required: false,
    },
    {
      name: "option2",
      label: "Option 2",
      description: "Optional value for the product's second option position.",
      type: "text",
      required: false,
    },
    {
      name: "option3",
      label: "Option 3",
      description: "Optional value for the product's third option position.",
      type: "text",
      required: false,
    },
    {
