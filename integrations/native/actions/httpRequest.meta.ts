...
export const httpRequestMeta: ActionMeta = {
  ...
  outputs: [
    ...
    { name: "body", type: "string", description: "Response body as text (up to 256 KiB; truncated beyond)." },
    { name: "bodyJson", type: "unknown", description: "Response body parsed as JSON when content-type is JSON and body is not truncated." },
