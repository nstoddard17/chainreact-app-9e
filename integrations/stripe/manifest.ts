...
export const stripeManifest: ProviderManifest = ProviderManifestSchema.parse({
  ...
  capabilities: {
    ...
    // True: 14 action handlers (create_customer, update_customer,
    ...
    // create_payment_link, create_invoice, get_payments) registered
    // in services/execution/handlers/_registry.ts. Slice 11 Commit 3
    // shipped 10; Stripe 2.1 Commits 1 + 2 + 3 + 4 added
