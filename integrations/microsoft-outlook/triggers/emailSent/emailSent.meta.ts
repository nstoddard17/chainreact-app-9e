...
export const outlookEmailSentTriggerMeta: TriggerMeta = {
  ...
  payloadShape: [
    ...
    { name: "subject", type: "string", description: "Subject. Empty string when Graph omits it." },
    ...
    { name: "to", type: "array", description: "ToRecipients as { name?, address } objects." },
    { name: "cc", type: "array", description: "CcRecipients as { name?, address } objects." },
    { name: "bcc", type: "array", description: "BccRecipients as { name?, address } objects." },
