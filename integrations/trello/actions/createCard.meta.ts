...
export const trelloCreateCardMeta: ActionMeta = {
  ...
  fields: [
    ...
    },
    {
      ...
      label: "Position",
      description:
        'Where the card lands in the list: "top", "bottom", or a number (e.g. 65536). Leave empty for Trello\'s default.',
      type: "text",
      required: false,
    ...
    },
    {
      name: "due",
      label: "Due Date",
      description: "Optional ISO-8601 due date, e.g. 2026-06-01T17:00:00Z.",
      type: "text",
      required: false,
    ...
    },
    {
      name: "start",
      label: "Start Date",
      description: "Optional ISO-8601 start date, e.g. 2026-05-01T09:00:00Z.",
      type: "text",
      required: false,
  ...
  outputs: [
    ...
    { name: "shortUrl", type: "string", description: "Short card URL." },
    { name: "idList", type: "string", description: "The list id." },
    { name: "idBoard", type: "string", description: "The board id." },
    {
      name: "desc",
      type: "string",
      description: "The card description (user-entered Markdown).",
      sensitive: true,
    },
    { name: "due", type: "string", description: "Due date (ISO-8601) or null." },
    { name: "dueComplete", type: "boolean", description: "Due-complete flag." },
    { name: "start", type: "string", description: "Start date (ISO-8601) or null." },
    ...
    { name: "pos", type: "number", description: "The card's position." },
  ],
