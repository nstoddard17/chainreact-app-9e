...
export const googleCalendarListEventsMeta: ActionMeta = {
  ...
  fields: [
    ...
    },
    {
      ...
      description: "ISO 8601 lower bound — only events ending after this are returned.",
      type: "text",
      required: false,
    ...
    },
    {
      name: "timeMax",
      label: "End Of Window",
      description: "ISO 8601 upper bound — only events starting before this are returned.",
      type: "text",
      required: false,
