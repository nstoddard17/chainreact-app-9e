...
export const googleCalendarCreateEventMeta: ActionMeta = {
  ...
  fields: [
    ...
    },
    {
      ...
      description: "ISO 8601 start. Required unless All Day is on.",
      type: "text",
      required: false,
    ...
    },
    {
      name: "endDateTime",
      label: "End Date-Time",
      description: "ISO 8601 end. Required unless All Day is on.",
      type: "text",
      required: false,
    ...
    },
    {
      name: "startDate",
      label: "Start Date",
      description: "YYYY-MM-DD start. Required when All Day is on.",
      type: "text",
      required: false,
    ...
    },
    {
      ...
      label: "End Date",
      description:
        "YYYY-MM-DD end (exclusive — the day after the event ends). Required when All Day is on.",
      type: "text",
      required: false,
