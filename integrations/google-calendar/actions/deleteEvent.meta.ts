...
export const googleCalendarDeleteEventMeta: ActionMeta = {
  ...
  outputs: [
    ...
    { name: "eventTitle", type: "string", description: "The deleted event's title (or null).", nullable: true },
    { name: "eventStart", type: "object", description: "The deleted event's start (or null).", nullable: true },
    { name: "eventEnd", type: "object", description: "The deleted event's end (or null).", nullable: true },
