...
export const microsoftOutlookCalendarUpdateEventMeta: ActionMeta = {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        "ISO 8601 start. To change times, set BOTH Start Date-Time AND End Date-Time — Graph rejects one-sided time edits.",
      type: "text",
      required: false,
    ...
    },
    {
      name: "endDateTime",
      label: "End Date-Time",
      description: "ISO 8601 end. Pair with Start Date-Time to change times.",
      type: "text",
      required: false,
