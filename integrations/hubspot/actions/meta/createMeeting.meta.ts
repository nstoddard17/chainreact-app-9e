...
export const hubspotCreateMeetingMeta: ActionMeta = {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        "Link this meeting to a contact — search contacts by name, paste a contact ID, or insert one from an earlier step. If linking fails the meeting is still created (see associationWarnings).",
      type: "combobox",
    ...
    },
    {
      ...
      description:
        "Link this meeting to a company — search companies by name, paste a company ID, or insert one from an earlier step. If linking fails the meeting is still created (see associationWarnings).",
      type: "combobox",
    ...
    },
    {
      ...
      description:
        "Link this meeting to a deal — search deals by name, paste a deal ID, or insert one from an earlier step. If linking fails the meeting is still created (see associationWarnings).",
      type: "combobox",
    ...
    },
    {
      ...
      description:
        "Link this meeting to a ticket — search tickets by subject, paste a ticket ID, or insert one from an earlier step. If linking fails the meeting is still created (see associationWarnings).",
      type: "combobox",
