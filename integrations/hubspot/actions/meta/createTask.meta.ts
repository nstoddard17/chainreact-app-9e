...
export const hubspotCreateTaskMeta: ActionMeta = {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        "Link this task to a contact — search contacts by name, paste a contact ID, or insert one from an earlier step. If linking fails the task is still created (see associationWarnings).",
      type: "combobox",
    ...
    },
    {
      ...
      description:
        "Link this task to a company — search companies by name, paste a company ID, or insert one from an earlier step. If linking fails the task is still created (see associationWarnings).",
      type: "combobox",
    ...
    },
    {
      ...
      description:
        "Link this task to a deal — search deals by name, paste a deal ID, or insert one from an earlier step. If linking fails the task is still created (see associationWarnings).",
      type: "combobox",
    ...
    },
    {
      ...
      description:
        "Link this task to a ticket — search tickets by subject, paste a ticket ID, or insert one from an earlier step. If linking fails the task is still created (see associationWarnings).",
      type: "combobox",
