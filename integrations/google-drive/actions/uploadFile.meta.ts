...
export const googleDriveUploadFileMeta: ActionMeta = {
  ...
  outputs: [
    ...
    { name: "webViewLink", type: "string", description: "Drive UI link to the file (or null).", nullable: true },
    { name: "size", type: "string", description: "Byte size as a string (or null).", nullable: true },
