...
export function NewHowItWorks() {
  ...
  useEffect(() => {
    ...
    const sequence = async () => {
      await new Promise(resolve => setTimeout(resolve, 2000)) // Initial state
      setOauthStep('clicking')
      await new Promise(resolve => setTimeout(resolve, 1600)) // Show click animation
      setOauthStep('oauth')
      await new Promise(resolve => setTimeout(resolve, 3000)) // OAuth window with cursor
      setOauthStep('authorizing')
      await new Promise(resolve => setTimeout(resolve, 1200)) // Authorizing
      setOauthStep('connected')
      await new Promise(resolve => setTimeout(resolve, 2200)) // Show connected state
      setOauthStep('initial')
    }
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24">
        <div className="text-center mb-16">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 mb-6">
              ...
              <span className="text-sm font-semibold text-blue-700 dark:text-blue-300">How It Works</span>
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                ...
                className={`cursor-pointer p-6 rounded-2xl border transition-all duration-300 ${
                  activeStep === index
                    ...
                    : 'bg-white dark:bg-slate-900/50 border-neutral-200 dark:border-neutral-800 hover:border-neutral-300 dark:hover:border-neutral-700'
                }`}
              >
                <div className="flex items-start gap-4">
                  <div className={`text-3xl font-bold ${
                    activeStep === index ? 'text-blue-600 dark:text-blue-400' : 'text-neutral-400 dark:text-neutral-600'
                  }`}>
                    {step.number}
                  </div>
                  ...
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-all ${
                    ...
                    {React.createElement(step.icon, {
                      className: `w-5 h-5 ${activeStep === index ? 'text-white' : 'text-neutral-600 dark:text-neutral-400'}`,
                    })}
                  </div>
                </div>
              </motion.div>
          ...
          <motion.div
            ...
            className="relative h-96 bg-white dark:bg-slate-900/50 rounded-2xl border border-neutral-200 dark:border-neutral-800 p-8 overflow-hidden"
          >
            {activeStep === 0 && (
              <div className="h-full flex flex-col">
                ...
                <div className="flex items-center justify-between mb-4 pb-3 border-b border-neutral-200 dark:border-neutral-800">
                  <h3 className="text-sm font-semibold text-neutral-900 dark:text-white">Integrations</h3>
                      ...
                      <motion.div
                        ...
                        className={`relative p-3 rounded-lg border transition-all ${
                          ...
                          isConnected
                            ...
                            : 'bg-neutral-50 dark:bg-slate-800/50 border-neutral-200 dark:border-neutral-800'
                        }`}
                      >
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          />
                          <div className="flex-1">
                            <p className="text-xs font-medium text-neutral-900 dark:text-white">{integration.name}</p>
                            <p className="text-xs text-neutral-500 dark:text-neutral-400">{integration.desc}</p>
                          </div>
                        </div>
                        ...
                        {isSlack && oauthStep === 'clicking' && (
                          ...
                          >
                            <MousePointer className="w-5 h-5 text-black fill-black" />
                          </motion.div>
                        )}
                      </motion.div>
                    )
                  ...
                  {(oauthStep === 'oauth' || oauthStep === 'authorizing') && (
                    ...
                    >
                      <motion.div
                        ...
                        className="w-64 bg-white dark:bg-slate-800 rounded-xl shadow-2xl border border-neutral-200 dark:border-neutral-800 overflow-hidden"
                      >
                        {/* OAuth Header */}
                        ...
                        <div className="p-4">
                          ...
                          <ul className="space-y-1 mb-4">
                            <li className="flex items-center gap-2">
                              ...
                              <span className="text-xs text-neutral-700 dark:text-neutral-300">View workspace info</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <CheckCircle className="w-3 h-3 text-green-500" />
                              <span className="text-xs text-neutral-700 dark:text-neutral-300">Send messages</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <CheckCircle className="w-3 h-3 text-green-500" />
                              <span className="text-xs text-neutral-700 dark:text-neutral-300">Read channels</span>
                            </li>
                          </ul>
                          ...
                          >
                            ...
                            {(oauthStep === 'oauth' || oauthStep === 'authorizing') && (
                              <motion.div
                                ...
                                animate={{
                                  x: oauthStep === 'authorizing' ? 0 : [50, 0, 0, 3, 0],
                                  y: oauthStep === 'authorizing' ? 0 : [-30, 0, 0, 2, 0],
                                  scale: oauthStep === 'authorizing' ? 0 : [0, 1, 1, 0.85, 1],
                                  opacity: oauthStep === 'authorizing' ? 0 : [0, 1, 1, 1, 1]
                                }}
                                transition={{
                                  delay: oauthStep === 'oauth' ? 0.8 : 0,
                                  duration: oauthStep === 'authorizing' ? 0.3 : 1.5,
                                  times: oauthStep === 'authorizing' ? undefined : [0, 0.3, 0.6, 0.8, 1],
                                  ease: "easeInOut"
                                }}
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="flex items-center justify-between mb-3 pb-2 border-b border-neutral-200 dark:border-neutral-800">
                  <div className="flex items-center gap-2">
                    <h3 className="text-sm font-semibold text-neutral-900 dark:text-white">Customer Support Automation</h3>
                    <span className="px-1.5 py-0.5 text-[10px] bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 rounded">Template</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <button className="px-2 py-0.5 text-xs bg-neutral-100 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-300 rounded">Save</button>
                    <button className="px-2 py-0.5 text-xs bg-green-500 text-white rounded">Activate</button>
                  </div>
                </div>

                {/* Canvas with Dot Grid Background */}
                <div className="flex-1 relative bg-neutral-50 dark:bg-neutral-900/50 rounded-lg overflow-hidden"
                     style={{
                  ...
                  <motion.div
                    ...
                    className="absolute bg-white dark:bg-neutral-800 rounded-lg shadow-sm border-2 border-blue-500 p-2.5 w-[140px] z-10"
                    style={{ left: '170px', top: '30px' }}
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <img src="/integrations/gmail.svg" alt="Gmail" className="w-5 h-5" />
                      <span className="text-xs font-semibold text-neutral-900 dark:text-white">New Email</span>
                    </div>
                    <p className="text-[10px] text-neutral-500 dark:text-neutral-400">When email received</p>
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs font-semibold text-neutral-900 dark:text-white">AI Classifier</span>
                    </div>
                    <p className="text-[10px] text-neutral-500 dark:text-neutral-400">Analyze & route</p>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    className="absolute bg-white dark:bg-neutral-800 rounded-lg shadow-sm border-2 border-neutral-300 dark:border-neutral-600 p-2.5 w-[130px] z-10"
                    style={{ left: '35px', top: '200px' }}
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <img src="/integrations/slack.svg" alt="Slack" className="w-5 h-5" />
                      <span className="text-xs font-semibold text-neutral-900 dark:text-white">Urgent Alert</span>
                    </div>
                    <p className="text-[10px] text-neutral-500 dark:text-neutral-400">Notify #support</p>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    className="absolute bg-white dark:bg-neutral-800 rounded-lg shadow-sm border-2 border-neutral-300 dark:border-neutral-600 p-2.5 w-[140px] z-10"
                    style={{ left: '170px', top: '200px' }}
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <img src="/integrations/gmail.svg" alt="Gmail" className="w-5 h-5" />
                      <span className="text-xs font-semibold text-neutral-900 dark:text-white">Auto Reply</span>
                    </div>
                    <p className="text-[10px] text-neutral-500 dark:text-neutral-400">Send response</p>
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs font-semibold text-neutral-900 dark:text-white">Create Ticket</span>
                    </div>
                    <p className="text-[10px] text-neutral-500 dark:text-neutral-400">Add to database</p>
                  </motion.div>
            ...
            {activeStep === 2 && (
              <div className="h-full flex flex-col">
                {/* Dashboard Header */}
                <div className="flex items-center justify-between mb-4 pb-3 border-b border-neutral-200 dark:border-neutral-800">
                  <h3 className="text-sm font-semibold text-neutral-900 dark:text-white">Workflow Dashboard</h3>
                  <motion.div
                ...
                {/* Recent Executions */}
                <div className="flex-1">
                  <p className="text-xs font-medium text-neutral-600 dark:text-neutral-400 mb-2">Recent Executions</p>
                  <div className="space-y-2">
                    {[
                      ...
                      <motion.div
                        ...
                        className="flex items-center justify-between p-2 bg-neutral-50 dark:bg-slate-800/50 rounded-lg"
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-neutral-700 dark:text-neutral-300">{execution.action}</span>
                        </div>
                        <span className="text-xs text-neutral-500 dark:text-neutral-400">{execution.time}</span>
                      </motion.div>
                    ))}
                  </div>
                </div>
                ...
                <div className="mt-3 pt-3 border-t border-neutral-200 dark:border-neutral-800">
                  <p className="text-xs font-medium text-neutral-600 dark:text-neutral-400 mb-2">Activity</p>
        ...
        >
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-2xl shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-300 transform hover:scale-105 group"
          >
            Join the Waitlist
