      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
        ...
        <div className="px-8 py-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-blue-200 mb-4">You agree not to use the Service to:</p>
            <ul className="list-disc pl-6 text-blue-200">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">5.3 Free Trial</h3>
            <p className="text-blue-200 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">9. AI-Powered Features</h2>
            <p className="text-blue-200 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">10.1 Service Availability</h3>
            <p className="text-blue-200 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">10.2 Limitation of Liability</h3>
            <p className="text-blue-200 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">10.3 Maximum Liability</h3>
            <p className="text-blue-200">
          ...
          <section className="mb-8">
            ...
            <p className="text-blue-200 mb-4">If you have any questions about these Terms, please contact us:</p>
