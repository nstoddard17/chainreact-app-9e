...
function Calendar({
  ...
  return (
    <>
      <style>{`
        .rdp-nav_button .lucide-chevron-left,
        .rdp-nav_button .lucide-chevron-right {
          color: black !important;
        }
        .dark .rdp-nav_button .lucide-chevron-left,
        .dark .rdp-nav_button .lucide-chevron-right {
      ...
      <DayPicker
        ...
        classNames={{
          ...
          nav_button: "inline-flex items-center justify-center rounded-md h-7 w-7 bg-transparent p-0 hover:bg-black/10 dark:hover:bg-white/20 transition-colors duration-200 text-black dark:text-white",
          nav_button_previous: "",
          nav_button_next: "",
