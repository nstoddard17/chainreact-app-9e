        ...
        <TooltipContent>
          <div className="space-y-1">
            ...
            {usage.usage_percent >= 100 && (
              <p className="text-xs text-red-600 dark:text-red-400 font-medium">Monthly limit reached</p>
            )}
            {usage.usage_percent >= 90 && usage.usage_percent < 100 && (
              <p className="text-xs text-orange-600 dark:text-orange-400 font-medium">High usage - consider upgrading</p>
            )}
            {usage.usage_percent >= 75 && usage.usage_percent < 90 && (
              <p className="text-xs text-yellow-600 dark:text-yellow-400 font-medium">Approaching limit</p>
            )}
