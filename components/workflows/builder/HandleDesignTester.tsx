                ...
                <div className="relative w-[400px] h-[120px] bg-background rounded-lg border-2 border-border shadow-sm">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderRight: design.id.includes('halfmoon') ? '1.5px solid oklch(var(--border))' : undefined,
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background: 'oklch(var(--muted) / 0.3)',
                      border: '1.5px solid oklch(var(--border))',
                      borderLeft: design.id.includes('halfmoon') ? '1.5px solid oklch(var(--border))' : undefined,
