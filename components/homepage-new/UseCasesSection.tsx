        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="mb-10">
              ...
              <div className="space-y-3">
                {selectedCase.workflow.map((step, index) => (
                  ...
                  >
                    <div className="w-6 h-6 rounded-full bg-orange-600 text-white flex items-center justify-center flex-shrink-0 text-xs font-bold">
                      {index + 1}
                    </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              {/* Build Time */}
              <div className="text-center p-4 rounded-lg bg-orange-50 dark:bg-orange-500/5 border border-orange-200 dark:border-orange-500/20">
                ...
                <div className="text-sm font-bold text-orange-700 dark:text-orange-300">15-30 minutes</div>
              </div>

              {/* Features */}
              <div className="text-center p-4 rounded-lg bg-rose-50 dark:bg-rose-500/5 border border-rose-200 dark:border-rose-500/20">
                <Zap className="w-6 h-6 text-rose-600 dark:text-rose-400 mx-auto mb-2" />
            ...
            <div className="mt-10 text-center">
              <Button
                ...
                className="bg-orange-600 hover:bg-orange-700 dark:bg-orange-500 dark:hover:bg-orange-600 text-white shadow-lg shadow-orange-500/20"
              >
                Build This Workflow
