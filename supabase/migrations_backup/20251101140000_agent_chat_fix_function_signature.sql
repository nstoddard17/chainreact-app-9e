-- Fix agent_chat_messages function signature conflict
-- Explicitly drop ALL versions of the function before recreating

-- Drop all possible function signatures
DROP FUNCTION IF EXISTS get_agent_chat_history(UUID, UUID, INTEGER, INTEGER);  -- Old 4-param version
DROP FUNCTION IF EXISTS get_agent_chat_history(UUID, INTEGER, INTEGER);        -- New 3-param version
...
-- IMPORTANT: This is the 3-parameter version that matches our API calls
