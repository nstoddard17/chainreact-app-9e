-- Clean migration for support tickets system
...
-- Test the migration by creating a sample ticket
DO $$
DECLARE
...
BEGIN
  ...
  INSERT INTO support_tickets (
    ...
    test_user_id,
    'Test Ticket',
    'This is a test ticket to verify the migration',
    'test@example.com',
    'CR-TEST-0001'
  ...
  -- Clean up test data
  DELETE FROM support_ticket_responses WHERE ticket_id = test_ticket_id;
  DELETE FROM support_tickets WHERE id = test_ticket_id;
  
  RAISE NOTICE 'Migration test completed successfully!';
END $$; 