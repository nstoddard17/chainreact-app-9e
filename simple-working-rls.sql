-- Simple working RLS - avoid complex cross-table references
-- Disable RLS first
...
-- Create very simple policies that don't cross-reference
-- Organizations: Only owners can access (API handles member access)
CREATE POLICY "organizations_owner_only" ON organizations
  FOR ALL USING (owner_id = auth.uid());

-- Organization members: Only organization owners can manage
...
-- Organization invitations: Only organization owners can manage
